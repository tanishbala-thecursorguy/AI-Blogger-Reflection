            ...
            <div className="professional-feature-card p-8 space-y-6 border-2">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  disabled={loading}
                  className="w-full professional-button-primary py-6 text-lg group bg-gray-900 hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
                ...
                {isHiringPerson && (
                  <Button
                    ...
                    disabled={loading}
                    className="w-full professional-button-cta py-6 text-lg group slide-in-down disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>
                        <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-white mr-3"></div>
